...
class OthersApiController extends Controller
{
    ...
    /**
     * @OA\Get (
     *     path="/api/{locale}/category/others/home",
     *     summary="Get posts by others category",
     *     description="Get posts by others category",
     *     operationId="OthersCategoryApiIndex",
     *     tags={"OthersCategoryApi"},
     *     @OA\Server(
     *     url="/",
    ...
    public function getOthersPosts($locale): CategoryParentApiResource
    {
        ...
        $categoryId = (int)config('config.category.others');
        ...
        if ($category) {
            ...
            // put in cache
            Cache::forever('others_category_posts_' . $locale, $posts->toArray());
    ...
    /**
     * @OA\Get (
     *     path="/api/{locale}/category/others/more",
     *     summary="Get posts by others more",
     *     description="Get posts by others more by paginate",
     *     operationId="OthersCategoryApiIndex",
     *     tags={"OthersCategoryApi"},
     *     @OA\Server(
     *     url="/",
    ...
    public function getCategoryMorePosts(Request $request, $locale): JsonResponse
    {
        ...
        $categoryId = (int)config('config.category.others');
        $ids = Cache::get('others_category_posts_' . $locale) ?? array();
